...
def load_m2m_config():
    ...
    if not config_file.exists():
        ...
        print("Deploy Gateway first: cd cdk && ./deploy.sh")
        print("(M2M config is auto-generated by CDK deployment)")
        sys.exit(1)
...
def load_gateway_outputs():
    ...
    if not outputs_file.exists():
        ...
        print("Run first: cd cdk && ./deploy.sh")
        sys.exit(1)
...
def main():
    ...
    if not gateway_outputs.get("cognito_configured"):
        ...
        print("   Redeploy Gateway: cd cdk && ./deploy.sh")
        sys.exit(1)
    ...
    if passed == total:
        ...
        print("\nTroubleshooting:")
        print("1. Check Gateway deployment: cd cdk && ./deploy.sh")
