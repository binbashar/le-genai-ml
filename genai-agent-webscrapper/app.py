...
def process_speech_to_speech(audio_data, bedrock_client, system_prompt=""):
    ...
    try:
        ...
        request_body = {
            ...
            "system": [
                {
                    "text": system_prompt if system_prompt else """Eres un asistente de voz amigable y conversacional. 
...
export AWS_DEFAULT_REGION=us-east-1
    ...
    with main_container:
        ...
        tab1, tab2, tab3 = st.tabs(["🎙️ Grabar ahora", "📁 Subir archivo", "⚙️ Configuración"])
        ...
        with tab1:
            ...
            with col2:
                ...
                # Botón de grabación
                if st.button(
                    "🎤 Presiona para grabar" if not st.session_state.recording else "⏹️ Detener grabación",
                    type="primary",
                    ...
                    if not st.session_state.recording:
                        ...
                        # Grabar audio
                        with st.spinner(f"🔴 Grabando por {duration} segundos... ¡Habla ahora!"):
                            try:
        ...
        with tab3:
            ...
            if st.button("💾 Guardar configuración"):
                ...
                st.session_state.custom_prompt = custom_prompt if custom_prompt else prompts.get(personality, prompts["Amigable"])
